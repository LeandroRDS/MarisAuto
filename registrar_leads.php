...
$vendedor_id = $_POST['vendedor_id'];//pegando o valor que esta na variavel vendedor_id no clikcimprar.ls atravez do metodo post.
$carro_id = $_POST['carro_id'];//pegano o valor que esta na variavel carro_id no arquivo clikcomprar.js atravez do metodo post e salvando ela na variavel carro_is para colocala no banco de dados.
